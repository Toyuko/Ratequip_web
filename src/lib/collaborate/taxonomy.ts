...
export const SEED_TAXONOMY: TaxonomyTerm[] = [
  ...
  {
    taxonomyId: "credential.hrw.lf",
    path: "credential/hrw/lf",
    label: "HRW forklift (LF)",
    synonyms: ["forklift ticket", "lf licence"],
    kind: "CREDENTIAL",
    curated: true,
  },
  {
    taxonomyId: "credential.white_card",
    path: "credential/white_card",
    label: "White Card / construction induction",
    synonyms: ["white card", "construction induction"],
    kind: "CREDENTIAL",
    curated: true,
  },
  {
    taxonomyId: "skill.plant.excavator",
    path: "industry/plant/excavator",
    label: "Excavator operator",
    synonyms: ["20t excavator", "plant operator"],
    kind: "SKILL",
    curated: true,
  },
  {
