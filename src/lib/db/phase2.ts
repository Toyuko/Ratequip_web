...
function mergeDemoCompanyEnrichment(company: DemoCompany): DemoCompany {
  ...
  return {
    ...
    phones: company.phones?.length ? company.phones : seed.phones,
    emails: company.emails?.length ? company.emails : seed.emails,
    addressLine: company.addressLine ?? seed.addressLine,
    region: company.region ?? seed.region,
    postalCode: company.postalCode ?? seed.postalCode,
