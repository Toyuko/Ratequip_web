    ...
    <div>
        ...
        <div className="mx-auto flex min-h-[88vh] max-w-6xl flex-col justify-center px-4 py-20 sm:px-6">
          <div className="rq-fade-up max-w-3xl">
            ...
            <p className="mt-5 max-w-xl text-lg text-slate-200 sm:text-xl">
              Independent B2B reputation, RFQs and equipment intelligence — so
              every purchase decision starts with verified evidence.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              >
                <Link href="/sign-up">Join RateQuip</Link>
              </Button>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <div className="mb-8 flex items-end justify-between gap-4">
          ...
          <Button asChild variant="outline">
            <Link href="/suppliers">View directory</Link>
          </Button>
        </div>
      ...
      <section className="bg-[var(--rq-navy)] py-16 text-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <h2 className="text-2xl font-bold">How RateQuip works</h2>
          <p className="mt-2 max-w-2xl text-slate-300">
            One workflow from need to verified supplier — without leaving the
            platform.
          </p>
            ...
            {[
              {
                icon: Search,
                title: "Discover",
                body: "Search suppliers by category, location and Trust Score.",
              },
              {
                icon: FileText,
                title: "Request",
                body: "Post RFQs, collect quotes and compare in one workspace.",
              },
              {
                icon: ShieldCheck,
                title: "Verify",
                body: "Upload purchase evidence and leave reviews that count.",
              },
            ].map((step) => (
              <div key={step.title}>
