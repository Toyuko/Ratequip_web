...
- Name: acceptance-audit.spec.ts >> Public pages smoke >> contact loads without 5xx
...
Call log:
  - navigating to "https://ratequip-web.vercel.app/contact", waiting until "domcontentloaded"
