...
- Name: acceptance-audit.spec.ts >> Protected routes deny guests >> dashboard-admin blocks unauthenticated access
...
Call log:
  - navigating to "https://ratequip-web.vercel.app/dashboard/admin", waiting until "domcontentloaded"
